// http://lookup-service-prod.mlb.com/json/named.roster_team_alltime.bam?start_season=%271994%27&end_season=%271994%27&team_id=%27120%27 
...
function yearInfo(year) //Used for getting user information; Primarily used to get the account's creation date
{
  const infoURL = "http://lookup-service-prod.mlb.com/json/named.roster_team_alltime.bam?start_season=%271994%27&end_season=%271994%27&team_id=%27120%27";
  let fullURL = infoURL + year + "%27&end_season=%27" + year + "%27&team_id=%27120%27";
  getData(fullURL, dataLoaded);
}
...
function dataLoaded(e) //Calls for dataURL
{
  ...
  results = obj.roster_team_alltime.row;
